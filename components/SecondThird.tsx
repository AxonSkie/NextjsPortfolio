    ...
    <div className="min-h-[100vh] w-full  flex flex-col  sm:flex-row">
      ...
      <div className="hidden sm:flex-1 sm:flex">
        ...
        <div className="flex-1  flex justify-center flex-col">
          <div className="flex-1  flex flex-col items-center justify-end mb-[30px] mr-[30px]">
            <h1 className="text-[40px] text-white font-advent">
              More <span className="text-red-redprim">Awesome Works</span>
            </h1>
            <div className="flex flex-row gap-[10px]">
              <div>
                <Image src={jujutsu} alt="random" className="w-[500px]"></Image>
              </div>
              <div>
                <Image src={kaisen} alt="random" className="w-[400px]"></Image>
              </div>
            </div>
          </div>
